...
const words = ["Tise", "uses", "storytelling", "&", "prototypes", "to", "solve", "problems"];
...
export function ProjectsHeading() {
  ...
  return (
    <h1
      className="text-2xl md:text-3xl font-bold tracking-wider text-neutral-200 text-center w-full relative"
